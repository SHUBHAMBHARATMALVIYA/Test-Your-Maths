...
function Question_ADD() {
    ...
    var question_2_add = Math.floor(Math.random() *rand_num_final_2);
    console.log(question_2_add);
    while (question_1_add==0){
        question_1_add = Math.floor(Math.random() *rand_num_final);
    }
    while (question_2_add==0){
        question_2_add = Math.floor(Math.random() *rand_num_final_2);
    }
    Final_answer_add = question_1_add * question_2_add;
    console.log(Final_answer_add);
    var question = "What is the product of " + question_1_add + " x " + question_2_add + "  ?";
